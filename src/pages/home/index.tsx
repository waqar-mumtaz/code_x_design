        ...
        <div className="grid grid-cols-2 mb-6 gap-10">
          ...
          <div className="px-14 pt-16 pb-24 border border-transparent border-b-blue-600 hover:border-pink-100 hover:border-b-blue-600 transition-colors duration-500">
            ...
            <p className="text-gray-500 lato-regular text-justify pr-5 text-sm">
              ...
              expertise in design and construction. Your attention to detail and
              commitment to excellence have made this project a success.
            </p>
            <div className="text-blue mt-2">
              <i className="fa-solid fa-star"></i>
              <i className="fa-solid fa-star"></i>
          ...
          <div className="px-14 pt-16 pb-24 border border-transparent border-b-blue-600 hover:border-pink-100 hover:border-b-blue-600 transition-colors duration-500">
            ...
            <div className="mt-7 mb-4 ">
              ...
              <p className="text-xs tracking-wider uppercase">online bechdo</p>
            </div>
            <p className="text-gray-500 lato-regular text-justify pr-5 text-sm">
              The classified ads website you developed for Online Bechdo is
              absolutely fantastic. It's user-friendly, visually appealing, and
              perfectly tailored to our needs. The platform has made it so much
              easier for users to buy and sell online.
            </p>
            <div className="text-blue mt-2">
              <i className="fa-solid fa-star"></i>
              <i className="fa-solid fa-star"></i>
          ...
          <div className="px-14 pt-16 pb-24 border border-transparent border-b-blue-600 hover:border-pink-100 hover:border-b-blue-600 transition-colors duration-500">
            ...
            <p className="text-gray-500 lato-regular text-justify pr-5 text-sm">
              The website developed for Innvotek Pharma beautifully captures our
              company's mission and professionalism. It's informative,
        ...
        <div className=" md:flex gap-10 items-center">
          <div className="text-center md:text-start">
            ...
            <p className="text-gray-600 py-2">
              ...
              you need to get in touch with a sales person right now, call us at
            </p>
