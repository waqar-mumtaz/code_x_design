  ...
  return (
    <section className="py-20 my-container">
      ...
      <div className="relative">
        ...
        <button className="testimonials-prev absolute -left-12 top-1/2 transform -translate-y-1/2 text-blue-600 text-2xl font-normal hover:opacity-70 transition-opacity z-10">
          ←
        </button>

        <button className="testimonials-next absolute -right-12 top-1/2 transform -translate-y-1/2 text-blue-600 text-2xl font-normal hover:opacity-70 transition-opacity z-10">
          →
        </button>
      </div>
    </section>
